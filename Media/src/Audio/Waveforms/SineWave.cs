...
/// </summary>
public class SineWave : BaseWaveform {
    ...
    /// <summary>
    /// Create a sine wave with the given wavelength and amplitude
    /// </summary>
    /// <param name="wavelength">wavelength</param>
    /// <param name="amplitude">amplitude</param>
    /// <param name="phase">phase</param>
    public SineWave(double wavelength, double amplitude = 1, double phase = 0) {
    ...
    public override double AmplitudeAt(double t) {
        return (Amplitude * Math.Sin((Pi2 * t - Phase) / Wavelength));
    }
}
